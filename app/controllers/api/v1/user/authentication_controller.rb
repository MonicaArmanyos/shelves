      ...
      def authenticate
        ...
        if command.success?
          ...
          if  @user.email_confirmed
            ...
            render json: {status: 'SUCCESS',user: @user, books: @user.books, auth_token: command.result, phones: @user.phones, addresses: @user.addresses, interests: @user_interests }, :except => [:password_digest], status: :created
